...
void MainWindow::on_sendCommonMessageButton_clicked()
{
    ...
    else      // If the user is banned
    {
        ...
        QMessageBox::critical(this, tr("You can't send messages until "), timeString);
    }
}
...
{
    if (this->getAdmin())  // If user is admin
    {
...
{
    QMessageBox::information(this, tr("Alert"), tr("This option is currently under development"));
}
