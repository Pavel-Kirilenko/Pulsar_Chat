...
QT_MOC_LITERAL(5, 40, 7), // "banTime"
QT_MOC_LITERAL(6, 48, 5), // "admin"
QT_MOC_LITERAL(7, 54, 17) // "onRejectRequested"

    },
    "StartScreen\0onLoggedIn\0\0userId\0userName\0"
    "banTime\0admin\0onRejectRequested"
};
...
static const uint qt_meta_data_StartScreen[] = {
 ...
 // slots: parameters
    QMetaType::Void, QMetaType::UInt, QMetaType::QString, QMetaType::QDateTime, QMetaType::Bool,    3,    4,    5,    6,
    QMetaType::Void,
...
void StartScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onLoggedIn((*reinterpret_cast< uint(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< QDateTime(*)>(_a[3])),(*reinterpret_cast< bool(*)>(_a[4]))); break;
